...
issue](https://github.com/cisagov/cyhy-kevsync/issues) in
...
request](https://github.com/cisagov/cyhy-kevsync/pulls),
...
```console
cd cyhy-kevsync
pyenv virtualenv <python_version_to_use> cyhy-kevsync
pyenv local cyhy-kevsync
